          ...
          child: Container(
              ...
              child: FutureBuilder<VendorModel>(
                ...
                builder: (context, snapshot) {
                  ...
                  else if (snapshot.data!.photos.isEmpty) return Center(child: showEmptyState("", "NoImages".tr()));
                            ...
                            child: InkWell(
                              ...
                              child: Card(
                                  ...
                                  shape: RoundedRectangleBorder(
                                      borderRadius: BorderRadius.circular(20.0), side: BorderSide(color: Color(0xffDEE3ED))),
