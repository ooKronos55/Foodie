...
import 'package:uber_eats_consumer/ui/checkoutScreen/CheckoutScreen.dart';
              ...
              if (razorPay) {
                ...
                FireStoreUtils.createPaymentId().then((value) {
                  ...
                  FireStoreUtils.topUpWalletAmount(
                          paymentMethod: "Wallet", isTopup: false, orderId: orderId, amount: widget.total, id: paymentID)
                      .then((value) {
                    FireStoreUtils.updateWalletAmount(amount: -widget.total).then((value) {
                      ...
                      showAlert(_scaffoldKey.currentContext!,
                          response: "Payment Successful Via".tr() + " " "Wallet".tr(), colors: Colors.green);
                    });
                  });
                });
              } else if (codPay) {
  ...
  _makePaypalPayment({required amount}) async {
    PayPalClientTokenGen.paypalClientToken(paypalSettingData: paypalSettingData!).then((value) async {
      ...
      var request = BraintreePayPalRequest(
          amount: amount, currencyCode: currencyData!.code, billingAgreementDescription: "djsghxghf", displayName: 'Foodies company');
