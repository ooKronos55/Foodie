...
import 'package:uber_eats_consumer/ui/orderDetailsScreen/OrderDetailsScreen.dart';
import 'package:uber_eats_consumer/ui/reviewScreen.dart/reviewScreen.dart';
...
class _OrdersScreenState extends State<OrdersScreen> {
      ...
      body: StreamBuilder<List<OrderModel>>(
          ...
          builder: (context, snapshot) {
            ...
            if (!snapshot.hasData || (snapshot.data?.isEmpty ?? true)) {
              return Center(
                child: showEmptyState('No Previous Orders'.tr(), "orders-food".tr()),
              );
            } else {
              ...
              return ListView.builder(
                  ...
                  itemBuilder: (context, index) => buildOrderItem(snapshot.data![index]));
            }
          }),
    );
  }
  ...
  Widget buildOrderItem(OrderModel orderModel) {
    ...
    orderModel.products.forEach((element) {
      print("${element.extras}---" + element.id);
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                          image: NetworkImage((orderModel.products.first.photo != null && orderModel.products.first.photo.isNotEmpty)
                                        ...
                                        Row(
                                          children: [
                                            Text(orderModel.status.tr(),
                                                style: TextStyle(
                                                    color: isDarkMode(context) ? Colors.grey.shade200 : Color(0XFF555353),
                                                    fontFamily: "Poppinsr")),
                                            SizedBox(width: 3),
                                            Image(
                  ...
                  children: [
                    ...
                    InkWell(
                      child: Container(
                          ...
                          child: Text(
                            'REORDER'.tr(),
                            style: TextStyle(
                                color: isDarkMode(context) ? Color(0xffFFFFFF) : Color(DARK_COLOR), fontFamily: "Poppinsm", fontSize: 15
                      ...
                      onTap: () {
                        ...
                        for (CartProduct productModel in orderModel.products) {
                          // print("cart item ${productModel.toJson()}  extr${productModel.extras}");
                    ...
                    InkWell(
                      child: Container(
                          ...
                          // primary: Colors.white,
                          decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(5), border: Border.all(width: 0.8, color: Color(0XFF82807F))),
                          child: Text(
                            'RATE ORDER'.tr(),
                            style: TextStyle(
                                color: isDarkMode(context) ? Color(0xffFFFFFF) : Color(DARK_COLOR), fontFamily: "Poppinsm", fontSize: 15),
  ...
  String? getPrice(OrderModel product, int index, CartProduct cartProduct) {
    ...
    var dCharge =
        product.deliveryCharge == null || product.deliveryCharge.toString().isEmpty ? 0.0 : double.parse(product.deliveryCharge.toString());
