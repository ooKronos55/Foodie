...
import 'package:uber_eats_consumer/model/PayPalCurrencyCodeErrorModel.dart' as payPalCurrModel;
import 'package:uber_eats_consumer/model/PayStackSettingsModel.dart';
import 'package:uber_eats_consumer/model/StripePayFailedModel.dart';
...
import 'package:uber_eats_consumer/model/paypalErrorSettle.dart';
import 'package:uber_eats_consumer/model/paypalPaymentSettle.dart' as payPalSettel;
...
import 'package:uber_eats_consumer/services/paypalclientToken.dart';
import 'package:uber_eats_consumer/services/paystack_url_genrater.dart';
import 'package:uber_eats_consumer/services/rozorpayConroller.dart';
import 'package:uber_eats_consumer/ui/wallet/MercadoPagoScreen.dart';
import 'package:uber_eats_consumer/ui/wallet/PayFastScreen.dart';
import 'package:uber_eats_consumer/ui/wallet/payStackScreen.dart';
...
class WalletScreenState extends State<WalletScreen> {
            ...
            Positioned(
              ...
              child: Container(
                decoration: BoxDecoration(
                    image: DecorationImage(fit: BoxFit.fitWidth, image: AssetImage("assets/images/wallet_background@3x.png"))),
                        ...
                        child: Padding(
                          ...
                          child: Card(
                            ...
                            child: RadioListTile(
                              shape: RoundedRectangleBorder(
                                  borderRadius: BorderRadius.circular(8),
                                  side: BorderSide(color: stripe ? Color(COLOR_PRIMARY) : Colors.transparent)),
                        ...
                        child: Padding(
                          ...
                          child: Card(
                            ...
                            child: RadioListTile(
                              shape: RoundedRectangleBorder(
                                  borderRadius: BorderRadius.circular(8),
                                  side: BorderSide(color: payStack ? Color(COLOR_PRIMARY) : Colors.transparent)),
                              controlAffinity: ListTileControlAffinity.trailing,
                              value: "PayStack",
                              groupValue: selectedRadioTile,
                              onChanged: (String? value) {
                        ...
                        child: Padding(
                          ...
                          child: Card(
                            ...
                            child: RadioListTile(
                              shape: RoundedRectangleBorder(
                                  borderRadius: BorderRadius.circular(8),
                                  side: BorderSide(color: flutterWave ? Color(COLOR_PRIMARY) : Colors.transparent)),
                              controlAffinity: ListTileControlAffinity.trailing,
                              value: "FlutterWave",
                              groupValue: selectedRadioTile,
                              onChanged: (String? value) {
                        ...
                        child: Padding(
                          ...
                          child: Card(
                            ...
                            child: RadioListTile(
                              ...
                              shape: RoundedRectangleBorder(
                                  borderRadius: BorderRadius.circular(8),
                                  side: BorderSide(color: razorPay ? Color(COLOR_PRIMARY) : Colors.transparent)),
                              contentPadding: EdgeInsets.symmetric(
                                horizontal: 6,
                              ),
                              controlAffinity: ListTileControlAffinity.trailing,
                        ...
                        child: Padding(
                          ...
                          child: Card(
                            ...
                            child: RadioListTile(
                              shape: RoundedRectangleBorder(
                                  borderRadius: BorderRadius.circular(8),
                                  side: BorderSide(color: payFast ? Color(COLOR_PRIMARY) : Colors.transparent)),
                              controlAffinity: ListTileControlAffinity.trailing,
                              value: "payFast",
                              groupValue: selectedRadioTile,
                              onChanged: (String? value) {
                        ...
                        child: Padding(
                          ...
                          child: Card(
                            ...
                            child: RadioListTile(
                              shape: RoundedRectangleBorder(
                                  borderRadius: BorderRadius.circular(8),
                                  side: BorderSide(color: payTm ? Color(COLOR_PRIMARY) : Colors.transparent)),
                              contentPadding: EdgeInsets.symmetric(
                                horizontal: 6,
                              ),
                              controlAffinity: ListTileControlAffinity.trailing,
                        ...
                        child: Padding(
                          ...
                          child: Card(
                            ...
                            child: RadioListTile(
                              shape: RoundedRectangleBorder(
                                  borderRadius: BorderRadius.circular(8),
                                  side: BorderSide(color: mercadoPago ? Color(COLOR_PRIMARY) : Colors.transparent)),
                              controlAffinity: ListTileControlAffinity.trailing,
                              value: "MercadoPago",
                              groupValue: selectedRadioTile,
                              onChanged: (String? value) {
                        ...
                        child: Padding(
                          ...
                          child: Card(
                            ...
                            child: RadioListTile(
                              shape: RoundedRectangleBorder(
                                  borderRadius: BorderRadius.circular(8),
                                  side: BorderSide(color: paypal ? Color(COLOR_PRIMARY) : Colors.transparent)),
                              contentPadding: EdgeInsets.symmetric(
                                horizontal: 6,
                              ),
                              controlAffinity: ListTileControlAffinity.trailing,
                        ...
                        child: GestureDetector(
                          onTap: () async {
                            ...
                            if (selectedRadioTile == "Stripe" && stripeData?.isEnabled == true) {
                              ...
                              showLoadingAlert();
                              PayStackURLGen.getPayHTML(payFastSettingData: payFastSettingData!, amount: _amountController.text)
                                  .then((value) async {
                                ...
                                if (isDone) {
                                  ...
                                  FireStoreUtils.createPaymentId().then((value) {
                                    ...
                                    FireStoreUtils.topUpWalletAmount(
                                            paymentMethod: "PayFast", amount: double.parse(_amountController.text), id: paymentID)
                                        .then((value) {
                              ...
                              showLoadingAlert();
                              RazorPayController()
                                  .createOrderRazorPay(isTopup: true, amount: int.parse(_amountController.text))
                                  .then((value) {
                                if (value != null) {
  ...
  void _handlePaymentSuccess(PaymentSuccessResponse response) {
    FireStoreUtils.createPaymentId().then((value) {
      final paymentID = value;
      FireStoreUtils.topUpWalletAmount(paymentMethod: "RazorPay", amount: double.parse(_amountController.text), id: paymentID)
          .then((value) {
        FireStoreUtils.updateWalletAmount(amount: double.parse(_amountController.text)).then((value) {
          Navigator.pop(context);
        });
          ...
          if (value['success'] == "true" || value['success'] == true) {
            if (value['data']['success'] == "true" || value['data']['success'] == true) {
              ...
              if (settleResult.data.success) {
                ...
                FireStoreUtils.createPaymentId().then((value) {
                  final paymentID = value;
                  FireStoreUtils.topUpWalletAmount(paymentMethod: "Paypal", amount: double.parse(_amountController.text), id: paymentID)
                      .then((value) {
                    FireStoreUtils.updateWalletAmount(amount: double.parse(_amountController.text)).then((value) {});
                  });
                });
  ...
  displayStripePaymentSheet() async {
    try {
      await stripe1.Stripe.instance.presentPaymentSheet().then((value) {
        FireStoreUtils.createPaymentId().then((value) {
          final paymentID = value;
          FireStoreUtils.topUpWalletAmount(paymentMethod: "Stripe", amount: double.parse(_amountController.text), id: paymentID)
              .then((value) {
            FireStoreUtils.updateWalletAmount(amount: double.parse(_amountController.text)).then((value) {});
          });
        });
    ...
    try {
      ...
      response.then((value) {
        if (value!["RESPMSG"] == "Txn Success") {
          ...
          FireStoreUtils.createPaymentId().then((value) {
            final paymentID = value;
            FireStoreUtils.topUpWalletAmount(paymentMethod: "Paytm", amount: double.parse(_amountController.text), id: paymentID)
                .then((value) {
    ...
    await PayStackURLGen.payStackURLGen(
      ...
      if (value != null) {
        ...
        if (isDone) {
          FireStoreUtils.createPaymentId().then((value) {
            final paymentID = value;
            FireStoreUtils.topUpWalletAmount(paymentMethod: "PayStack", amount: double.parse(_amountController.text), id: paymentID)
                .then((value) {
              FireStoreUtils.updateWalletAmount(amount: double.parse(_amountController.text)).whenComplete(() {});
            });
          });
    ...
    makePreference().then((result) async {
      if (result.isNotEmpty) {
        ...
        final bool isDone = await Navigator.push(
            context, MaterialPageRoute(builder: (context) => MercadoPagoScreen(initialURl: result['response']['init_point'])));
        print(isDone);
        ...
        if (isDone) {
          FireStoreUtils.createPaymentId().then((value) {
            final paymentID = value;
            FireStoreUtils.topUpWalletAmount(paymentMethod: "Mercado Pago", amount: double.parse(_amountController.text), id: paymentID)
                .then((value) {
              FireStoreUtils.updateWalletAmount(amount: double.parse(_amountController.text)).whenComplete(() {
                Navigator.pop(_scaffoldKey.currentContext!);
              });
  ...
  _flutterWaveInitiatePayment(
    ...
    if (response != null && response.toString().isNotEmpty) {
      if (response.success!) {
        FireStoreUtils.createPaymentId().then((value) {
          final paymentID = value;
          FireStoreUtils.topUpWalletAmount(paymentMethod: "FlutterWave", amount: double.parse(_amountController.text), id: paymentID)
              .then((value) {
            FireStoreUtils.updateWalletAmount(amount: double.parse(_amountController.text)).whenComplete(() {
              Navigator.pop(_scaffoldKey.currentContext!);
              ScaffoldMessenger.of(_scaffoldKey.currentContext!).showSnackBar(SnackBar(
