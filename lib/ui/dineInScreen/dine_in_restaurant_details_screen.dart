...
import 'package:uber_eats_consumer/model/SpecialDiscountModel.dart';
...
import 'package:uber_eats_consumer/ui/fullScreenImageViewer/FullScreenImageViewer.dart';
import 'package:uber_eats_consumer/ui/vendorProductsScreen/VendorProductsScreen.dart';
import 'package:uber_eats_consumer/ui/vendorProductsScreen/photos.dart';
import 'package:uber_eats_consumer/ui/vendorProductsScreen/review.dart';
import 'package:uber_eats_consumer/ui/vendorProductsScreen/services.dart';
...
class _DineInRestaurantDetailsScreenState extends State<DineInRestaurantDetailsScreen> {
        ...
        widget.vendorModel.specialDiscount.forEach((element) {
          if (day == element.day.toString()) {
            if (element.timeslot!.isNotEmpty) {
              ...
              print("---->2 " + employeeWithMaxSalary.discount.toString());
              if (employeeWithMaxSalary.discount_type == "dinein") {
  ...
  timeSet(Timestamp selectedDate) {
    ...
    for (DateTime time = startTime; time.isBefore(endTime); time = time.add(Duration(minutes: 30))) {
      ...
      print("Enter " + now.toString());
      print("Enter " + time.toString());
      if (widget.vendorModel.specialDiscount.isNotEmpty && widget.vendorModel.specialDiscountEnable) {
        widget.vendorModel.specialDiscount.forEach((element) {
          if (day == element.day.toString()) {
            print("Enter 1");
            if (element.timeslot!.isNotEmpty) {
              element.timeslot!.forEach((element) {
                if (element.discount_type == "dinein") {
                  print("Enter 2");
                                ...
                                Column(children: [
                                  ...
                                  Text(
                                    ...
                                    style: TextStyle(
                                        ...
                                        letterSpacing: 0.5,
                                        color: isDarkMode(context) ? Colors.white60 : Color(0xff565764)),
                                  ).tr()
                                ]),
                                Column(children: [
                                  Image(
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            GestureDetector(
                              onTap: () {
                                push(context, VendorProductsScreen(vendorModel: widget.vendorModel));
                              },
                              child: new Align(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                        ...
                                        border: Border.all(width: 1, color: isDarkMode(context) ? Color(COLOR_PRIMARY) : Colors.black54)),
                                    child: Icon(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                          widget.vendorModel.restaurantCost == 0
                                              ...
                                              : "Cost for two - $symbol${widget.vendorModel.restaurantCost} (Approx)",
                                          style: TextStyle(
                                            fontFamily: "Poppinssm",
                                          )).tr()
                                    ],
                                ...
                                InkWell(
                                  onTap: () {
                                    launchUrl(createCoordinatesUrl(
                                        widget.vendorModel.latitude, widget.vendorModel.longitude, widget.vendorModel.title));
                                  },
  ...
  resttiming() {
    if (widget.vendorModel.reststatus == true) {
      ...
      return Container(
          height: 35,
          decoration: BoxDecoration(
              color: Color(0XFFF1F4F7), borderRadius: BorderRadius.only(topLeft: Radius.circular(10), bottomLeft: Radius.circular(10))),
          padding: EdgeInsets.only(right: 40, left: 10),
          child: Row(children: [
            Icon(
              Icons.circle,
                          ...
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    bool isSelected =
                                        selectedTimeSlot == DateFormat('hh:mm a').format(timeSlotList[index].time!) ? true : false;
                                    return Padding(
                                      padding: const EdgeInsets.symmetric(horizontal: 2.0, vertical: 8),
                                      child: GestureDetector(
                                        onTap: () {
                                ...
                                InkWell(
                                  onTap: () {
                                    showCustomDialog(context, userDisFName, userDisLName, userDisPhone, userDisEmail, () {
                                      print("first action $userDisFName lan $userDisLName ema $userDisEmail");
                                      setState(() {});
                                    });
                                  },
                                  child: Text(
                      ...
                      Padding(
                        ...
                        child: MaterialButton(
                          ...
                          onPressed: () async {
                            ...
                            String hour = DateFormat("kk:mm").format(DateFormat('hh:mm a')
                                .parse((Intl.getCurrentLocale() == "en_US") ? selectedTimeSlot : selectedTimeSlot.toLowerCase()));
                            dt = DateTime(dt.year, dt.month, dt.day, int.parse(hour.split(":")[0]), int.parse(hour.split(":")[1]),
                            ...
                            FireStoreUtils.sendFcmMessage(
                                'New Booking Request!',
                                '${MyAppState.currentUser!.firstName}' + " has Request for Table Booking.",
                      ...
                      children: ListTile.divideTiles(context: context, tiles: [
                        ListTile(
                          ...
                          trailing: ConstrainedBox(
                            ...
                            child: TextFormField(
                              onSaved: (String? val) {
                                print("first f $val lan $userDisLName ema $userDisEmail");
                                userDisFName = val!;
                              },
                        ...
                        ListTile(
                          ...
                          trailing: ConstrainedBox(
                            ...
                            child: TextFormField(
                              onSaved: (String? val) {
                                print("first l $userDisFName lan $val ema $userDisEmail");
                                userDisLName = val!;
                              },
                              validator: validateName,
                              textInputAction: TextInputAction.next,
