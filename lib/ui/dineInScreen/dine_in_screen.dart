...
import 'package:uber_eats_consumer/ui/dineInScreen/dine_in_restaurant_details_screen.dart';
...
class _DineInScreenState extends State<DineInScreen> {
  ...
  _getLocation() async {
    ...
    List<Placemark> placemarks =
        await placemarkFromCoordinates(MyAppState.selectedPosotion.latitude, MyAppState.selectedPosotion.longitude);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: isLocationAvail
          ? showEmptyState("notHaveYourLocation", "locationSearchingRestaurants".tr(), action: () async {
                ...
                children: [
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Text(currentLocation.toString(),
                                  ...
                                  style: TextStyle(color: Color(COLOR_PRIMARY), fontFamily: "Poppinsr"))
                              .tr(),
                        ),
                        InkWell(
                          onTap: () {
                  ...
                  Padding(
                    ...
                    child: Text("Find your restaurant",
                            style: TextStyle(
                                fontSize: 24, color: isDarkMode(context) ? Colors.white : Color(0xFF333333), fontFamily: "Poppinssb"))
                        .tr(),
                  ),
                  buildDineInTitleRow(
  ...
  Future<void> getTempLocation() async {
    debugPrint('location: ${MyAppState.selectedPosotion}');
  ...
  buildCategoryItem(CuisineModel cuisineModel) {
    return Padding(
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              CachedNetworkImage(
                imageUrl: getImageVAlidUrl(cuisineModel.photo),
                imageBuilder: (context, imageProvider) => Container(
                  height: MediaQuery.of(context).size.height * 0.11,
                  width: MediaQuery.of(context).size.width * 0.22,
                  decoration:
                      BoxDecoration(border: Border.all(width: 4, color: Color(COLOR_PRIMARY)), borderRadius: BorderRadius.circular(25)),
                  child: Container(
  ...
  String? getKm(double latitude, double longitude) {
    double distanceInMeters =
        Geolocator.distanceBetween(latitude, longitude, MyAppState.selectedPosotion.latitude, MyAppState.selectedPosotion.longitude);
    double kilometer = distanceInMeters / 1000;
    print("KiloMeter${kilometer}  ${MyAppState.selectedPosotion} ${latitude} ${longitude}");
                          ...
                          setState(() {
                            if (lstFav.contains(vendor.id) == true) {
                              FavouriteModel favouriteModel =
                                  FavouriteModel(restaurant_id: vendor.id, user_id: MyAppState.currentUser!.userID);
      ...
      child: Container(
        ...
        child: Align(
          ...
          child: Row(
            ...
            children: [
              Text(titleValue.tr(),
                  style: TextStyle(color: isDarkMode(context) ? Colors.white : Color(0xFF000000), fontSize: 16, fontFamily: "Poppinsm")),
              isViewAll!
                  ? Container()
                  : GestureDetector(
                      onTap: () {
