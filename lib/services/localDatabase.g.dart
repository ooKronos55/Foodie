...
class CartProduct extends DataClass implements Insertable<CartProduct> {
  ...
  late dynamic? extras;
  late final String? customization_price;
  ...
  factory CartProduct.fromData(Map<String, dynamic> data, GeneratedDatabase db, {String? prefix}) {
    ...
    return CartProduct(
      ...
      size: const StringType().mapFromDatabaseResponse(data['${effectivePrefix}size']),
    );
  }
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    print("cart io ${(extras is String)} ? ${(extras == "[]")} :: ${(extras.toString().isEmpty)}  ${extras} ");
  ...
  @override
  int get hashCode => Object.hash(id, name, photo, price, discountPrice, vendorID, quantity, extras_price, extras, size);
...
class $CartProductsTable extends CartProducts with TableInfo<$CartProductsTable, CartProduct> {
  ...
  late final GeneratedColumn<String?> photo =
      GeneratedColumn<String?>('photo', aliasedName, false, type: const StringType(), requiredDuringInsert: true);
  final VerificationMeta _priceMeta = const VerificationMeta('price');
  @override
  late final GeneratedColumn<String?> price =
      GeneratedColumn<String?>('price', aliasedName, false, type: const StringType(), requiredDuringInsert: true);
  final VerificationMeta _discountPriceMeta = const VerificationMeta('discountPrice');
  @override
  late final GeneratedColumn<String?> discountPrice =
      GeneratedColumn<String?>('discount_price', aliasedName, true, type: const StringType(), requiredDuringInsert: false);
  final VerificationMeta _vendorIDMeta = const VerificationMeta('vendorID');
  @override
  late final GeneratedColumn<String?> vendorID =
      GeneratedColumn<String?>('vendor_i_d', aliasedName, false, type: const StringType(), requiredDuringInsert: true);
  final VerificationMeta _quantityMeta = const VerificationMeta('quantity');
  @override
  late final GeneratedColumn<int?> quantity =
      GeneratedColumn<int?>('quantity', aliasedName, false, type: const IntType(), requiredDuringInsert: true);
  final VerificationMeta _extras_priceMeta = const VerificationMeta('extras_price');
  @override
  late final GeneratedColumn<String?> extras_price =
      GeneratedColumn<String?>('extras_price', aliasedName, true, type: const StringType(), requiredDuringInsert: false);
  final VerificationMeta _extrasMeta = const VerificationMeta('extras');
  @override
  late final GeneratedColumn<String?> extras =
      GeneratedColumn<String?>('extras', aliasedName, true, type: const StringType(), requiredDuringInsert: false);
  final VerificationMeta _sizeMeta = const VerificationMeta('size');
  @override
  late final GeneratedColumn<String?> size =
      GeneratedColumn<String?>('size', aliasedName, true, type: const StringType(), requiredDuringInsert: false);

  @override
  List<GeneratedColumn> get $columns => [id, name, photo, price, discountPrice, vendorID, quantity, extras_price, extras, size];
