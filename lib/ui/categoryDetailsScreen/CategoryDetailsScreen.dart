...
class _CategoryDetailsScreenState extends State<CategoryDetailsScreen> {
  ...
  void initState() {
    ...
    categoriesFuture = fireStoreUtils.getVendorsByCuisineID(widget.category.id, isDinein: widget.isDineIn);
  }
                ...
                child: CachedNetworkImage(
                  ...
                  imageBuilder: (context, imageProvider) => Container(
                    decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(20), image: DecorationImage(image: imageProvider, fit: BoxFit.cover)),
                  ),
